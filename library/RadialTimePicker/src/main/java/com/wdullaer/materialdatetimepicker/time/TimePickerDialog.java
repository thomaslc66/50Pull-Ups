...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute, int position);
    }
    ...
    public TimePickerDialog(Context context, int theme, OnTimeSetListener callback,
            int hourOfDay, int minute, boolean is24HourMode, int position) {
        // Empty constructor required for dialog fragment.
    }
    ...
    public static TimePickerDialog newInstance(OnTimeSetListener callback,
        ...
        ret.initialize(callback, hourOfDay, minute, is24HourMode, position);
        return ret;
    }
            ...
            public void onClick(View v) {
                ...
                if (mCallback != null) {
                    mCallback.onTimeSet(mTimePicker,
                            mTimePicker.getHours(), mTimePicker.getMinutes(), mPosition);
                }
                dismiss();
            }
        });
